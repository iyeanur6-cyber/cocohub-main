...
```kotlin
package com.cocohub.monitoring
...
final class HangMonitor {
    ...
    private let monitorQueue = DispatchQueue(label: "com.cocohub.hangmonitor")
...
```json
{
  ...
  "threadName": "main",
  "stackTrace": "at com.cocohub.MainActivity.onCreate(MainActivity.kt:45)\n...",
  "appVersion": "1.0.0",
