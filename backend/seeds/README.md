# Cocohub Database Seeding

This directory contains the database seeding system for Cocohub development and testing. It generates realistic test data including sample users, pets, medical records, appointments, and medications.
...
- PostgreSQL database with Cocohub schema
...
```bash
# Set DATABASE_URL
export DATABASE_URL="postgresql://postgres:postgres@localhost:5432/cocohub"
...
```bash
export DATABASE_URL="postgresql://user:password@localhost:5432/cocohub"
```
