 ...
 *   CDN_BASE_URL              — Public CDN origin (e.g. https://cdn.cocohub.app)
...
const CDN_BASE_URL = (process.env.CDN_BASE_URL ?? 'https://cdn.cocohub.app').replace(/\/$/, '');
const CDN_SIGNING_SECRET = process.env.CDN_SIGNING_SECRET ?? 'cocohub-dev-cdn-secret';
...
const CDN_BUCKET = process.env.CDN_BUCKET ?? 'cocohub-photos';
