      ...
      <View style={[styles.overlay, { backgroundColor: colors.overlay }]}>
        ...
        >
          ...
          <Text style={[styles.body, { color: colors.secondaryText }]}>
            {isForce
              ? 'A critical update is required to continue using Cocohub. Please update the app from the store.'
              : 'A new version of Cocohub is ready. Update now for the latest features and fixes.'}
          </Text>
