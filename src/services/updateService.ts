...
const STORE_URLS = {
  ios: extra.IOS_STORE_URL ?? 'https://apps.apple.com/app/cocohub/id000000000',
  android:
    extra.ANDROID_STORE_URL ?? 'https://play.google.com/store/apps/details?id=app.cocohub.mobile',
};
