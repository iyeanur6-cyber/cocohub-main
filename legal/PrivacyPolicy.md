...
Cocohub ("we," "our," or "us") is committed to protecting your privacy and personal data. This Privacy Policy explains how we collect, use, store, and share information when you use the Cocohub mobile application ("App") and associated services.

By using Cocohub, you consent to the practices described in this policy. If you do not agree, please do not use the App.
...
Cocohub uses the **Stellar blockchain network** to create tamper-evident records of medical event hashes. **Important:** Only cryptographic hashes (not personally identifiable information) are written to the blockchain. This enables:
...
- Protect the rights, property, or safety of Cocohub, our users, or the public
...
- **Community Posts:** If you post in the community feed, that data is visible to other Cocohub users based on your privacy settings.
...
If Cocohub undergoes a merger, acquisition, or asset sale, your data may be transferred as part of that transaction. We will notify you via email and in-App notification before such a transfer, and the new entity will honor this Privacy Policy.
...
- **Request correction** of inaccurate data by contacting support@cocohub.app
...
The App is **not directed at children under 13** (or the age of digital consent in your jurisdiction). We do not knowingly collect data from children. If we learn we have collected data from a child, we will delete it promptly. Parents who believe their child has provided data should contact us at support@cocohub.app.

## 7. International Data Transfers

Cocohub operates globally with cloud infrastructure in multiple regions. Your data may be stored and processed in the United States or other countries where our service providers operate. We ensure appropriate safeguards (Standard Contractual Clauses, GDPR-compliant agreements) are in place for cross-border data transfers.
...
- Updated policy published at https://cocohub.app/privacy
...
**Email:** privacy@cocohub.app  
**Postal Mail:** Cocohub Legal Department, [Insert Physical Address]  
**Data Protection Officer:** dpo@cocohub.app
...
**Thank you for trusting Cocohub with your pet's health information.**
